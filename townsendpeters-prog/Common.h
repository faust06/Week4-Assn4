...
//constants
const int   HASH_TABLE_MINIMUM_SIZE = 20,                     //smallest hashtable size that can be used
            RANDOM_ARRAY_UNIQUE_VALUES = 20,                  //number of unique values in array containing random values
